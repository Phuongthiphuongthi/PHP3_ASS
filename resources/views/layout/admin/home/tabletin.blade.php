...
@section('title', 'Trang quản trị tin')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Quản trị tin</h4>
                            </div><!-- end card header -->
                                ...
                                <div class="listjs-table" id="customerList">
                                    <div class="row g-4 mb-3">
                                        <div class="col-sm-auto">
                                            <div>
                                                <button type="button" class="btn btn-success add-btn lr-75"
                                                    data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal">
                                                    <a href="{{ route('addtin') }}">Thêm mới</a>
                                                </button>
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                @foreach ($tin as $tin)
                                                    <tr>
                                                        ...
                                                        <td>{{ $tin->updated_at }}</td>
                                                        <td>{{ $tin->id_loaitin }}</td>
                                                        {{-- <td>{{ $tin->id_tacgia }}</td> --}}
                                                        <td><button class="btn btn-sm btn-success edit-item-btn"
                                                                data-bs-toggle="modal"><a
                                                                    href="{{ route('edittin', $tin->id) }}">Sửa</a></button>
                                                        </td>

                                                        <td>
                                                            <form action="{{ route('deletetin', $tin->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
                                                                <button type="submit"
                                                ...
                                                {{-- <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#showModal">Sửa</button>
                                                        </div>
                                                        <div class="remove">
                                                            <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Xóa</button>
                                                        </div>
                                                    </div>
                                                </td> --}}
                                            </tbody>
