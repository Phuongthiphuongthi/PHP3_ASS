    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div style="height: 50vh; display: flex; align-items: center; justify-content: center;">
                <h1 style="font-family: 'Roboto', sans-serif; font-weight: bold; font-size: 2.5rem;">
                    Hi! Đây là trang chủ Admin ....
                </h1>
            </div>
                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <button type="button" class="btn btn-success add-btn lr-75" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal">
