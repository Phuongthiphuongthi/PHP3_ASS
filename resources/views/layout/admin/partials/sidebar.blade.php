    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('admin')}}"  role="button" >
                        <i class="ri-layout-3-line"></i> <span data-key="t-dashboards">Trang chủ</span>
                    </a>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('tableloaitin')}}"  >
                        <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Quản trị loại tin</span>
                    </a>
                    <div class=" menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('addloaitin')}}" class="nav-link" data-key="t-analytics"> Thêm loại tin </a>
                            </li>
                            {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('tabletin')}}" >
                        <i class="ri-apps-2-line"></i> <span data-key="t-apps">Quản trị tin</span>
                    </a>
                    <div class=" menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('addtin')}}" class="nav-link" data-key="t-chat"> Thêm tin </a>
                            </li>
