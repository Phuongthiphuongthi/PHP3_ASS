...
<div class="instafeed text-center mb-5">
    ...
    {{-- <div class="instagram-slider">
      <div class="instagram-post"><img src="{{asset('reader/images')."/".$dataCT->img }}"></div>
...
<div class="container">
    ...
    <div class="col-md-2 text-center mb-4">
        <a href="index.html"><img class="img-fluid" width="100px" src="reader/images/logo.png" alt="Reader | Hugo Personal Blog Template"></a>
    </div>
